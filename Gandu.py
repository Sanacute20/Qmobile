...
'\x1b[1;91m'   Author      ||    YOUR IT MASTER     
'\x1b[1;92m'   Github      ||     subhanXkhan  
'\x1b[1;93m'   FB ID       ||    Saahir Khan
'\x1b[1;94m'   TOOL TYPE   ||    PAID
'\x1b[1;96m'   WAP NUMBER  ||     03167560832            
'\x1b[1;91m' ༄Mr𝙧᭄•─────────────────•༄Khan𝙧᭄
"""
dec="2"
server="2"
...
def main_apv():
    ...
    r1=requests.get("https://pastebin.com/raw/JFwxMC5T").text
    if key1 in r1:
        main_system()
    else:
        os.system("clear")
...
def mineExt():
    ...
    print g+"[=] Extracting From SUBHAN : "+my_line[:15]
    r = requests.get('https://graph.facebook.com/' + my_line[:15] + '/friends?access_token=' + token)
    z = json.loads(r.text)# Decompile by KangEhem:)
